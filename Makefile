...
push:
	...
	cd /tmp/hortont.com ; make ; s3sync -r --progress -v --make-dirs --cache-control="no-cache" -p /tmp/hortont.com/output/ files.hortont.com:www ; rsync -a --progress /tmp/hortont.com/output/ asdfaoeuarst.com:/srv/www
